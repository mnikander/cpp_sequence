...
#include "../../src/prototype_stage/direct_take.hpp"


TEST(prototype_direct_take, zero)
{
    using namespace seq;
...
TEST(prototype_direct_take, one)
{
    using namespace seq;
    std::vector<i64> result{};
...
TEST(prototype_direct_take, two)
{
    using namespace seq;
    std::vector<i64> result{};
...
TEST(prototype_direct_take, five)
{
    using namespace seq;
    std::vector<i64> result{};
...
TEST(prototype_direct_take, halt_and_attempt_restart)
{
    using namespace seq;
    std::vector<i64> result{};
    std::vector<i64> const expected{0, 1};
...
TEST(prototype_direct_take, map_three_numbers)
{
    using namespace seq;
...
TEST(prototype_direct_take, three_even_numbers)
{
    using namespace seq;
    std::vector<i64> result{};
...
TEST(prototype_direct_take, nested_call)
{
    using namespace seq;
    std::vector<i64> result{};
    std::vector<i64> const expected{0, 2, 4};
